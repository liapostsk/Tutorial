...
public class GameController {
    ...
    @GetMapping(path = "")
    //Al poner el campo required = false, el parametro title es opcional sino saltaria excepcion al no especificarlo
    ...
    @PutMapping(path = { "", "/{id}" }) //RequestMapping(path = { "", "/{id}" }, method = PUT)
